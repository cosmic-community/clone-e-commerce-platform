          ...
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-4 space-y-4">
              ...
              <nav className="space-y-4">
                <Link href="/new" className="block text-black font-medium">New</Link>
                <Link href="/men" className="block text-black font-medium">Men</Link>
                <Link href="/women" className="block text-black font-medium">Women</Link>
                <Link href="/kids" className="block text-black font-medium">Kids</Link>
